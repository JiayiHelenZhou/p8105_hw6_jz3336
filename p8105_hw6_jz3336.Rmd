...
```
__comment__: 
The best model is model three which used head circumference, length, sex, and all interactions (including the three-way interaction) between these as the predictors.
